...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-rniftyreg-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rniftyreg-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-rniftyreg
# for installing globally
pixi global install r-rniftyreg
```
...
It is possible to list all of the versions of `r-rniftyreg` available on your platform:
...
```
pixi search r-rniftyreg --channel conda-forge
```
